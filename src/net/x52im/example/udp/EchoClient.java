...
public class EchoClient
{
	public static void main(String[] args) throws Exception
	{
		...
		while(true)
		{
			 ...
			 * ff 149 108
			 */
			byte[] soServerBytes108 = {(byte) 0xff,0x00,0x6c,(byte)0x95,0x05,0x05,0x00,0x00,0x01,0x00,0x20,
					(byte)0xda,0x12,(byte)0xd1,0x7e,0x13,(byte)0x89,0x17,0x04,0x06,0x00,0x01,
					0x07,0x50,0x50,0x22,0x12,0x05,0x04,
					//Valid-H
					(byte)0x0f,(byte)0xff,
					//1 Sensor Board LS 数据
			...
			// 开始发送
			//ok send 149
			//boolean ok = UDPUtils.send(soServerBytes108, soServerBytes108.length);
